...
export default class EmployeeStore {
  ...
  EditEmployee(Employee: EmployeeModel) : void {
    const indexNum = this.Employees.findIndex((emp: EmployeeModel) =>  emp.pk_EmployeeId === Employee.pk_EmployeeId);
  ...
  DeleteEmployee(Employee: EmployeeModel) : void {
    ...
    //delete this.Employees[indexNum];
