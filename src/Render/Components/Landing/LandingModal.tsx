...
export default function LandingModal(Props: Props) : ReactElement {
    ...
    // setTimeout(() => {Props.close(e)}, 200);

    const handleClose = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
        const modal = document.querySelector('.modal');
        modal.classList.toggle('modal1');
        setTimeout(() => {Props.hide(e)}, 200);
        ...
        <div className="modal-wrapper" aria-modal aria-hidden tabIndex={-1} role="dialog">
            <div className="modal">
                <div className="modal-header">
                    <div></div>
                <button type="button" className="modal-close-button" data-dismiss="modal" aria-label="Close" onClick={(e) => {handleClose(e)}}>
